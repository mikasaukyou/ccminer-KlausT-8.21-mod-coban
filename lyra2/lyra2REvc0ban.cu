...
void lyra2vc0ban_hash(void *state, const void *input)
{
	...
	LYRA2(hashB, 32, hashA, 32, hashA, 32, 1, 4, 4, LYRA2_NOBUG, 0);
	...
	uint32_t *hashes_done)
{
	...
	// GTX1660Ti(PL60) : 43.7MH/s (1536 Core, 1680MHz) : 43,700,000[H/s] * 0.1[s] / 1536 / 1680 = 1.693
	...
	if (device_sm[dev_id] >= 750) intensity *= 1.693;
	else if (device_sm[dev_id] >= 700) intensity *= 1.478;
